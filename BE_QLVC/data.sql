...
(
    ...
    image Varchar
                            (255) NOT NULL,
    FOREIGN KEY
                            (ID_LHH) REFERENCES LoaiHH
                            (ID_LHH),
    FOREIGN KEY
                            (ID_TCHH) REFERENCES TinhChatHH
                            (ID_TCHH)
);
    ...
    GhiChu VARCHAR
                                    (255) NULL,
    FOREIGN KEY
                                    (ID_NV) REFERENCES NhanVien
                                    (ID_NV),
    FOREIGN KEY
                                    (ID_KH) REFERENCES KhachHang
                                    (ID_KH),
    FOREIGN KEY
                                    (ID_HH) REFERENCES HangHoa
                                    (ID_HH),
    FOREIGN KEY
                                    (ID_NN) REFERENCES NguoiNhan
                                    (ID_NN)
);
    ...
    DoanhThu DECIMAL
                                                (10,2) NOT NULL,
    FOREIGN KEY
                                                (ID_BC) REFERENCES BaoCao
                                                (ID_BC),
    FOREIGN KEY
                                                (ID_TT) REFERENCES ThanhToan
                                                (ID_TT)
);
