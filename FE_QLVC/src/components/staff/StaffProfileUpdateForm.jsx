...
import './StaffProfileUpdateForm.css';

const StaffProfileUpdateForm = ({ user, onUpdateSuccess }) => {
    ...
    const handleProfileSubmit = async (e) => {
        ...
        try {
            ...
            await authService.updateStaffProfile(user.ID_NV, formData);
    ...
    return (
        <div className="staff-profile-update-container">
            <div className="staff-form-section">
                ...
                {showProfileForm && (
                    <form onSubmit={handleProfileSubmit}>
                        ...
                        <button type="submit" className="staff-update-btn" disabled={loading}>
            ...
            <div className="staff-form-section">
                ...
                {passwordError && <div className="staff-error-message">{passwordError}</div>}
                {passwordSuccess && <div className="staff-success-message">{passwordSuccess}</div>}
                ...
                {showPasswordForm && (
                    <form onSubmit={handlePasswordSubmit}>
                        ...
                        <button type="submit" className="staff-update-btn" disabled={passwordLoading}>
...
export default StaffProfileUpdateForm;
